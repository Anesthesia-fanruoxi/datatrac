...
func (s *TaskService) GetConfigWithRealTimeStructure(id string) (*TaskConfigWithRealTime, error) {
	realTimeService := NewTaskRealTimeService()
	return realTimeService.GetConfigWithRealTimeStructure(s, id)
}
...
func (s *TaskService) Delete(id string) error {
	...
	statsService.ClearTaskStats(id, task.TargetID)
