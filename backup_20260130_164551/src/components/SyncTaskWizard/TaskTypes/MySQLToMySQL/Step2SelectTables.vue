  ...
  selectedDatabases.value.forEach(db => {
    ...
    switch (batchMode.value) {
      ...
      case 'prefix':
        ...
        } else if (!batchSourcePrefix.value && batchTargetPrefix.value) {
          // 如果没有源前缀，只有目标前缀，则添加目标前缀
      ...
      case 'suffix':
        ...
        } else if (!batchSourceSuffix.value && batchTargetSuffix.value) {
          // 如果没有源后缀，只有目标后缀，则添加目标后缀
